...
const SignUp: Component<{ timeToLogin: Setter<boolean> }> = ({ timeToLogin }) => {
      ...
      <Match when={greetingName().length != 0 && signingUp() === false}>
        <div class="home-login">
          <div>
            ...
            <p>please <button onClick={timeToLogin}><strong>login</strong></button> now with yuor new account</p>
          </div>
        </div>
      </Match>
    </Switch>
